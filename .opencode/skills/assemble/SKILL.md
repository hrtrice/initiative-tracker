...
For each member, create `.opencode/memory/agents/<name>/learnings.md`:
...
Write `.opencode/memory/team/decisions.md`:
...
Write `.opencode/memory/team/retro-history.md`:
...
- `.claude/team.yaml`
- `.opencode/memory/agents/<name>/learnings.md` for each member
- `.opencode/memory/team/decisions.md`
- `.opencode/memory/team/retro-history.md`
...
|------|------|-------|-----------|
| [role] | [patterns] | [model] | .opencode/memory/agents/[name]/learnings.md |
| ... | ... | ... | ... |

### Files Created
- `.claude/team.yaml` — Team manifest
- `.opencode/memory/agents/*/learnings.md` — Per-member learnings ([count] files)
- `.opencode/memory/team/decisions.md` — Shared decisions log
- `.opencode/memory/team/retro-history.md` — Retro history
