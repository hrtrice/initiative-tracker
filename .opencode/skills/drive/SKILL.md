...
1. `.opencode/memory/epics/*/epic.md` — most recent epic
...
Write initial state to `.opencode/memory/scratch/drive-state.md`:
...
Read and update `.opencode/memory/scratch/drive-state.md`:
...
2. Read `.opencode/memory/scratch/drive-state.md`
...
8. **Compaction resilience.** Per `rules/memory-layout.md`, `.opencode/memory/scratch/drive-state.md` is the recovery file. Update at Phase 4; reread on resume.
