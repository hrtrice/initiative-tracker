...
Create a handoff task in your task tracker with the full handoff note content, or write the handoff note to `.opencode/memory/handoff-[date].md` for persistent reference if the project has a `.opencode/memory/` directory.
