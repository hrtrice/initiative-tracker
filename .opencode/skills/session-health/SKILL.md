...
| **Checkpoint & Continue** | Moderate load, mid-batch work, or want a save point | Commit current work, write intermediate results to `.opencode/memory/scratch/<slug>.md` if mid-batch, sync task state, then continue |
