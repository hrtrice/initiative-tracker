...
For each member, read `.opencode/memory/agents/<name>/learnings.md`. Note relevant learnings that might affect planning for this goal.

### 1c. Read Team Decisions

Read `.opencode/memory/team/decisions.md` for prior decisions that constrain this goal.
