...
Agent: <agent-name>
Learnings file: .opencode/memory/agents/<agent-name>/learnings.md
...
1. **Compaction resilience**: Per `rules/memory-layout.md`, checkpoint at phase boundaries to `.opencode/memory/scratch/tend-checkpoint.md`.
